...
# important hyper-parameters to investigate
...
"""
recordFolder = "experiments/thres99"+str(VERSION) # ehis the default save directory, but we can change model_dir by argparser
